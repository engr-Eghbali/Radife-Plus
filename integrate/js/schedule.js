...
///////////////////////////////////////////////////////////////////
  ...
  function cancelSchedule(orderID){

    var xhttp = new XMLHttpRequest();
    var datas ="customer="+localStorage.getItem("radife-phone")+"&key="+localStorage.getItem("radife-verify")+"&orderID="+orderID;
    ...
    xhttp.open("POST", "http://88.99.111.101:8081/cancelSchedule", true);
...
////////////////////////////////////////////////////////////////////// 
  var xhttp = new XMLHttpRequest();
  var datas ="customer="+localStorage.getItem("radife-phone")+"&key="+localStorage.getItem("radife-verify");
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
     ...
     if(this.responseText!="0"){
      ...
      $("#hisrow").after(divContainer);
      toPersian(document.body);
  ...
  xhttp.open("POST", "http://88.99.111.101:8081/showSchedule", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send(datas);
